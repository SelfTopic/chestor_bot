...
списание, +health вместе с max_health) делает прод-StatUpgradeService.purchase()
как есть; его build_message() собирает aiogram-клавиатуру, поэтому текст и кнопки
собираются здесь (build_shop) по той же формуле.
